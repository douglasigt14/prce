    ...
    <div class="row align-items-center mt-3 mb-3">
        <div class="col-12">
            <label for="frutas">Empreendimento:</label>
                <select class="form-control" id="frutas">
        ...
        <div class="col-md-12">
          <div class="w-100 d-flex align-items-center justify-content-center">
            ...
            <button type="button" class="btn btn-primary w-50 mt-3 mb-3" data-bs-toggle="modal"
              data-bs-target="#modalEmpreendimentos">Adicionar nova planta</button>
          </div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Líder em seu segmento na América Latina, a Smart Fit é uma das academias mais modernas e democráticas para você treinar e colocar a saúde em dia.</td>
