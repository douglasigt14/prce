        ...
        <div class="row g-3 mb-3 align-items-start">
          ...
          <div class="col-7">
            ...
            for ($i = 1; $i <= 6; $i++) {
              ...
              <div class="row g-3 mb-3 align-items-center">
                <div class="col-6">
                  <label for="titulo_diferencial<?php echo $i ?>" class="form-label fw-bold">Titulo Diferencial
                    <?php echo $i ?>
                  </label>
                  <input name="titulo_diferencial<?php echo $i ?>" type="text" class="form-control"
                    id="titulo_diferencial<?php echo $i ?>">
                </div>
                <div class="col-6">
                  <label for="texto_diferencial1" class="form-label fw-bold">Texto Diferencial
                    <?php echo $i ?>
                  </label>
                  <textarea name="texto_diferencial<?php echo $i ?>" class="form-control"
                    id="texto_diferencial<?php echo $i ?>" rows="3"></textarea>
                </div>
              </div>
            <?php
            }
