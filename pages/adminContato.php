        ...
        <form action="<?= Functions::urlBase('upload.php'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="row" id="selecaoCapa">
                    ...
                    <div class="col-2"></div>
                    <img id="capa" class="col-8 img-fluid mt-3 mb-3">
                    <div class="col-2"></div>
                </div>

                <div class="row g-3 mb-3 align-items-center">
                <div class="col-6">
                        <label for="titulo" class="form-label fw-bold">Titulo 1</label>
                        <input type="text" name="titulo" class="form-control" id="titulo">
                    </div>
                    <div class="col-6">
                        <label for="texto" class="form-label fw-bold">Texto 1</label>
...
<script type="text/javascript">
    ...
    const url = root + `/requests/select.php?table=contatos`;
